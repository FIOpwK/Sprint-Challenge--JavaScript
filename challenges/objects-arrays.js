...
const trex = {name: 'tyrannosaurus', diet: 'carnivorous', weight: '70000kg', length: '12m', period: 'Late Cretaceous', roar: function() {return 'RAWERSRARARWERSARARARRRR!!'}}

// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
const stegosaur = {name: 'stegosaurus', diet: 'herbivorous', weight: '2000kg', length: '9m', period: 'Late Jurassic'}
...
zooAnimals.map(name => {return lowCaseAnimalNames.push(`${name.animal_name.toLowerCase()}`)})
